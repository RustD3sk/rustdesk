...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі Titanext Tech..."),
        ...
        ("install_tip", "Через UAC в деяких випадках Titanext Tech може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення Titanext Tech в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати Titanext Tech дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати Titanext Tech дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити Titanext Tech використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [Titanext Tech Input]."),
        ...
        ("Language", "Мова"),
        ("Keep Titanext Tech background service", "Зберегти фонову службу Titanext Tech"),
        ...
        ("Show Titanext Tech", "Показати Titanext Tech"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати Titanext Tech дозвіл на \"Запис аудіо\""),
