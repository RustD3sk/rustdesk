...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til Titanext Tech-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan Titanext Tech ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere Titanext Tech på systemet"),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give Titanext Tech mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [Titanext Tech Input] tjenesten."),
        ...
        ("Language", "Sprog"),
        ("Keep Titanext Tech background service", "Behold Titanext Tech baggrundstjeneste"),
        ...
        ("Show Titanext Tech", "Vis Titanext Tech"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
