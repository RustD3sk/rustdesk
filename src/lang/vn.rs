...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Titanext Tech..."),
        ...
        ("install_tip", "Do UAC, Titanext Tech sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài Titanext Tech vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Click to download", "Nhấn để tải xuống"),
        ("Click to update", "Nhấn để cập nhật"),
        ("Configure", "Cài đặt"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho Titanext Tech"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho Titanext Tech."),
        ("Installing ...", "Đang cài ..."),
        ("Install", "Cài"),
        ("Installation", "Cài"),
        ...
        ("android_input_permission_tip1", "Để thiết bị từ xa điều khiển thiết bị Android của bạn bằng chuột hoặc chạm, bạn cần cho phép Titanext Tech sử dụng dịch vụ \"Trợ năng\"."),
        ("android_input_permission_tip2", "Vui lòng chuyển đến trang cài đặt hệ thống tiếp theo, tìm và nhập [Dịch vụ đã cài đặt], bật dịch vụ [Titanext Tech Input]."),
        ...
        ("Language", "Ngôn ngữ"),
        ("Keep Titanext Tech background service", "Giữ dịch vụ nền Titanext Tech"),
        ("Ignore Battery Optimizations", "Bỏ qua các tối ưu pin"),
        ("android_open_battery_optimizations_tip", "Nếu bạn muốn tắt tính năng này, vui lòng chuyển đến trang cài đặt ứng dụng Titanext Tech tiếp theo, tìm và nhập [Pin], Bỏ chọn [Không hạn chế]"),
        ...
        ("Show Titanext Tech", "Hiện Titanext Tech"),
        ("This PC", ""),
        ("or", "hoặc"),
        ...
        ("config_input", "Để điều khiển được máy tính từ xa với bàn phím, bạn cần cho phép Titanext Tech quyền \"Theo dõi đầu vào\" (Input Monitoring)"),
        ("config_microphone", "Để nói chuyện từ xa, bạn phải cho phép Titanext Tech quyền \"Ghi âm thanh\" (Record Audio)"),
        ...
        ("still_click_uac_tip", "Vẫn cần người dùng từ xa nhấn OK trên cửa sổ UAC của Titanext Tech đang chạy."),
        ...
        ("confirm_idd_driver_tip", "Tùy chọn cài đặt driver màn hình ảo đã được bật. Lưu ý rằng một chứng nhận thử sẽ được cài đặt để tin cậy driver màn hình ảo. Chứng nhận thử này sẽ chỉ được dùng để tin cậy những driver của Titanext Tech."),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Titanext Tech"),
