...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Titanext Tech..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Titanext Tech fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera Titanext Tech på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge Titanext Tech \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Titanext Tech \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Titanext Tech Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep Titanext Tech background service", "Behåll Titanext Tech i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Titanext Tech programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on Boot", ""),
        ...
        ("Show Titanext Tech", "Visa Titanext Tech"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
