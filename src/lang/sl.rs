...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Titanext Tech..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Titanext Tech v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ...
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Titanext Tech Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Titanext Tech background service", "Ohrani RustDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Titanext Tech, poiščite »Baterija« in izklopite »Neomejeno«"),
        ("Start on Boot", ""),
        ...
        ("Show Titanext Tech", "Prikaži Titanext Tech"),
