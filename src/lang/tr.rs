...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, Titanext Tech bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, Titanext Tech'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için Titanext Tech'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için Titanext Tech'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, Titanext Tech'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [Titanext Tech Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep Titanext Tech background service", "Titanext Tech arka plan hizmetini sürdürün"),
        ...
        ("Show Titanext Tech", "Titanext Tech'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
