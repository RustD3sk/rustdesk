...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Titanext Tech..."),
        ...
        ("install_tip", "Din cauza restricțiilor UAC, e posibil ca Titanext Tech să nu funcționeze corespunzător. Pentru a evita acest lucru, fă clic pe butonul de mai jos pentru a instala Titanext Tech."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Titanext Tech acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Titanext Tech acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Titanext Tech să utilize serviciul Accesibilitate."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, caută și deschide [Aplicații instalate] și activează serviciul [Titanext Tech Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep Titanext Tech background service", "Rulează serviciul Titanext Tech în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Titanext Tech, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ("Start on Boot", ""),
        ...
        ("Show Titanext Tech", "Afișează Titanext Tech"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
