...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Titanext Tech network..."),
        ...
        ("install_tip", "Due to UAC, Titanext Tech can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Titanext Tech to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Titanext Tech \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Titanext Tech \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Titanext Tech to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Titanext Tech Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Titanext Tech application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Titanext Tech \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Titanext Tech."),
        ("config_microphone", "In order to speak remotely, you need to grant Titanext Tech \"Record Audio\" permissions."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter Titanext Tech password"),
        ("remember_rustdesk_passwd_tip", "Remember Titanext Tech password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify Titanext Tech password"),
